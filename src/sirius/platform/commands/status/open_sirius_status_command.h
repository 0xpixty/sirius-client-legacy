...
#ifndef SIRIUS_PLATFORM_COMMANDS_STATUS_OPEN_SIRIUS_STATUS_COMMAND_H
#define SIRIUS_PLATFORM_COMMANDS_STATUS_OPEN_SIRIUS_STATUS_COMMAND_H
...
namespace sirius::platform::commands
{
	...
	class COpenSiriusStatusCommand final : public ICommand
	{
	public:
		explicit COpenSiriusStatusCommand(features::CSiriusStatusFeature &Feature);
		~COpenSiriusStatusCommand() noexcept override;
